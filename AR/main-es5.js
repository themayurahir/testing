...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _gltf_gltf_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./gltf/gltf.component */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_gltf_gltf_component__WEBPACK_IMPORTED_MODULE_1__["GltfComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _videojs_viewer_videojs_viewer_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./videojs-viewer/videojs-viewer.component */
    "./src/app/videojs-viewer/videojs-viewer.component.ts");
    /* harmony import */


    var _face_filter_face_filter_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./face-filter/face-filter.component */
    "./src/app/face-filter/face-filter.component.ts");
    /* harmony import */


    var _gltf_gltf_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./gltf/gltf.component */
    "./src/app/gltf/gltf.component.ts");
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _videojs_viewer_videojs_viewer_component__WEBPACK_IMPORTED_MODULE_4__["VideojsViewerComponent"], _face_filter_face_filter_component__WEBPACK_IMPORTED_MODULE_5__["FaceFilterComponent"], _gltf_gltf_component__WEBPACK_IMPORTED_MODULE_6__["GltfComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppFaceFilterFaceFilterComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FaceFilterComponent", function () {
      return FaceFilterComponent;
    });
    /* harmony import */
    ...
    var facefilter_helpers_JeelizThreejsHelper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! facefilter/helpers/JeelizThreejsHelper.js */
    "./node_modules/facefilter/helpers/JeelizThreejsHelper.js");
    /* harmony import */


    var facefilter_helpers_JeelizThreejsHelper_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(facefilter_helpers_JeelizThreejsHelper_js__WEBPACK_IMPORTED_MODULE_1__);
    /* harmony import */


    var _assets_js_stl_loader_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../assets/js/stl-loader.js */
    "./src/assets/js/stl-loader.js");
    /* harmony import */


    var _assets_js_stl_loader_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_assets_js_stl_loader_js__WEBPACK_IMPORTED_MODULE_2__); // import * as THREE from '../../assets/js/three.min.js';
    ...
    var FaceFilterComponent = /*#__PURE__*/function () {
      function FaceFilterComponent() {
        var _this = this;

        _classCallCheck(this, FaceFilterComponent);

        this.detect_callback = function (isDetected) {
          if (isDetected) {
        ...
        this.init_faceFilter = function (videoSettings) {
          ...
          JEEFACEFILTERAPI.init({
            ...
            callbackReady: function callbackReady(errCode, spec) {
              ...
              _this.init_threeScene(spec);
            },
            // called at each render iteration (drawing loop)
            callbackTrack: function callbackTrack(detectState) {
              THREE.JeelizHelper.render(detectState, _this.THREECAMERA);
            } // end callbackTrack()
      ...
      _createClass(FaceFilterComponent, [{
        key: "init_threeScene",
        value: function init_threeScene(spec) {
          console.log('inside init_threeScene');
          console.log('THREE.JeelizHelper:', THREE.JeelizHelper);
          var threeStuffs = THREE.JeelizHelper.init(spec, this.detect_callback); // Create the JSONLoader for our hat:

          var loader = new THREE.BufferGeometryLoader(); // const loader = new THREE.STLLoader();
          // Load our cool hat:

          loader.load('assets/js/models/luffys_hat.json', function (geometry, materials) {
            ...
            var hatMesh = new THREE.Mesh(geometry, mat);
          ...
          threeStuffs.scene.add(ambientLight); // CREATE THE CAMERA
        ...
        value: function main() {
          ...
          JeelizResizer.size_canvas({
            canvasId: 'jeeFaceFilterCanvas',
            callback: function callback(isError, bestVideoSettings) {
              console.log('Best:', _this2);

              _this2.init_faceFilter(bestVideoSettings);
            }
          });
        }
      }, {
    ...
    FaceFilterComponent.ɵfac = function FaceFilterComponent_Factory(t) {
      return new (t || FaceFilterComponent)();
    };

    FaceFilterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: FaceFilterComponent,
      selectors: [["app-face-filter"]],
      decls: 1,
      vars: 0,
      consts: [["width", "600", "height", "600", "id", "jeeFaceFilterCanvas"]],
      template: function FaceFilterComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FaceFilterComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppGltfGltfComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GltfComponent", function () {
    ...
    var GltfComponent = /*#__PURE__*/function () {
      function GltfComponent(renderer2, _document) {
        _classCallCheck(this, GltfComponent);
      ...
      _createClass(GltfComponent, [{
        key: "loadScripts",
        value: function loadScripts() {
          // This array contains all the files/CDNs 
          var dynamicScripts = ['assets/js/webgl.js', 'assets/js/jeelizFaceFilterES6.js', 'assets/js/stl/three.js', // 'https://threejs.org/build/three.js',
          'assets/js/stl/STLLoader.js', 'assets/js/JeelizResizer.js', 'assets/js/JeelizThreejsHelper.js', 'assets/js/demo.js'];
    ...
    GltfComponent.ɵfac = function GltfComponent_Factory(t) {
      return new (t || GltfComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_1__["DOCUMENT"]));
    };

    GltfComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: GltfComponent,
      selectors: [["app-gltf"]],
      decls: 19,
      vars: 0,
      consts: [["id", "jeeFaceFilterCanvas", 1, "videoRotate"], [1, "questions"], ["id", "step-0", 1, "step"], [1, "intro"], ["id", "start"], ["id", "step", "data-step-num", "0", 1, "step", 2, "display", "none"], ["data-question-id", "0", 1, "question"], ["data-answer-id", "0", 1, "answer"], [1, "prev"], [1, "next"], [1, "house"], [1, "zoomInUp"], [1, "house-name"], ["id", "house-img"]],
      template: function GltfComponent_Template(rf, ctx) {
        if (rf & 1) {
  ...
  /***/
  function srcAppVideojsViewerVideojsViewerComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "VideojsViewerComponent", function () {
      return VideojsViewerComponent;
    });
    /* harmony import */
    ...
    var videojs_vr_dist_videojs_vr_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! videojs-vr/dist/videojs-vr.js */
    "./node_modules/videojs-vr/dist/videojs-vr.js");
    /* harmony import */


    var videojs_vr_dist_videojs_vr_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(videojs_vr_dist_videojs_vr_js__WEBPACK_IMPORTED_MODULE_2__);

    var _c0 = ["my_video"];

    var VideojsViewerComponent = /*#__PURE__*/function () {
      function VideojsViewerComponent() {
        _classCallCheck(this, VideojsViewerComponent);
      ...
      _createClass(VideojsViewerComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        value: function ngAfterViewInit() {
          ...
          // setup the player
          this.player = Object(video_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this.element.nativeElement, this.config, function () {
            console.log('Using video.js ' + video_js__WEBPACK_IMPORTED_MODULE_1__["default"].VERSION);

            _this3.player.src(_this3.url);
    ...
    VideojsViewerComponent.ɵfac = function VideojsViewerComponent_Factory(t) {
      return new (t || VideojsViewerComponent)();
    };

    VideojsViewerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: VideojsViewerComponent,
      selectors: [["app-videojs-viewer"]],
      viewQuery: function VideojsViewerComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 3,
      vars: 0,
      consts: [[1, "video-view"], ["controls", "", "preload", "auto", "crossorigin", "use-credentials", 1, "video-js", "vjs-default-skin"], ["my_video", ""]],
      template: function VideojsViewerComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VideojsViewerComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAssetsJsStlLoaderJs(module, exports) {
    /**
